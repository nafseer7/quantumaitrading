        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <motion.div {...fadeInUp} className="space-y-4">
              <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
                ...
                <span className="text-sm sm:text-base lg:text-lg text-white ml-2 font-medium">Rated 4.8 stars by over 9,150 users</span>
              </div>
            </motion.div>

            <motion.div {...fadeInUp}>
              <div className="border border-white/10 rounded-lg sm:rounded-xl p-4 sm:p-5 lg:p-6 backdrop-blur-sm bg-white/5">
                <h3 className="text-gray-300 uppercase text-xs sm:text-sm font-medium tracking-wider mb-3 sm:mb-4 lg:mb-6">Trusted by Industry Leaders</h3>
          ...
          >
            <div className="bg-white/10 backdrop-blur-xl rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 shadow-2xl border border-white/10 w-full">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white mb-4 sm:mb-6 lg:mb-8">Start Trading Now</h2>
